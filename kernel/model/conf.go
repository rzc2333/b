...
func InitConf() {
	...
	if util.ContainerStd == util.Container {
		Conf.System.ID = "Sovereign-ID"   // 强制固定，不让真实的随机 ID 写入配置文件
		Conf.System.Name = "Sovereign-Node" // 强制固定设备名
	}
...
func Close(force, setCurrentWorkspace bool, execInstallPkg int) (exitCode int) {
	...
	if !skipNewVerInstallPkg() && "" != newVerInstallPkgPath {
		if 2 == execInstallPkg || (force && 0 == execInstallPkg) { // 执行新版本安装
            ...
            logging.LogInfof("Sovereign defensive: skipped auto installation of new version.")
